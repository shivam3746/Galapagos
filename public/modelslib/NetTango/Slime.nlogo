globals [wiggle-angle wiggle-bias sniff-threshold sniff-angle]
...
to setup
  ...
  set wiggle-angle 40
  set wiggle-bias 0
  set sniff-threshold 1
  set sniff-angle 45
  reset-ticks
end

to go
  ask turtles [ do-slime-things ]
  diffuse chemical slime-fade                      ;; diffuse chemical to neighboring patches
  ask patches
...
; NETTANGO START do-slime-things
to do-slime-things
